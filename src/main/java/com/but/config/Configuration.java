package com.but.config;

import com.but.Enum.Device;
import com.but.Enum.Urls;
...
public class Configuration {
    ...
    public Configuration(){
        ...
        email           = System.getProperty("email", (String) prop.get("email","calvinbijog@gmail.com"));
        pwd             = System.getProperty("pwd", (String) prop.get("pwd","C@l20bijog"));
